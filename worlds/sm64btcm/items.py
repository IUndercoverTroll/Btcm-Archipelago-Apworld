...
DEFAULT_ITEM_CLASSIFICATIONS = {
    ...
    "Wallet": ItemClassification.progression_deprioritized_skip_balancing,
    ...
    "Fast Foot Badge": ItemClassification.useful | ItemClassification.progression,
    ...
    "Squish Badge": ItemClassification.useful | ItemClassification.progression,
    ...
    "HP Regen Badge": ItemClassification.useful | ItemClassification.progression,
